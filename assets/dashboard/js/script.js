(function ($) {
        ...
        if ($(this).val()) {
            ...
            if(Filetype == "image/jpeg" || Filetype == "image/png" || Filetype == "image/jpg"){
                if (FileSize > 3) {
                    ...
                    swal({
                      title: "Notifikasi",
                      text: "Ukuran File Maximal 3 MB! Silahkan kecilkan ukuran gambar terlebih dahulu",
                      icon: "error",
                      buttons: ["Compress Gambar Disini", true],
                    })
                    .then((noresize) => {
                        if (noresize) {
                ...
                $(this).val('')
                return swal("Notifikasi", "Extensi file yang dizinkan PNG, JPG & JPEG", "error")
            }
        }
    });
    ...
    $(".mode").on("click", function () {
        if($(".mode").hasClass('darkmode')){
            $(".mode").addClass('lightmode');
            $(".mode").removeClass('darkmode');
            localStorage.setItem('body-mode', 'lightmode');
        }else{
