<div class="sidebar-wrapper">
  <div>
    <div class="logo-wrapper"><a href="<?php echo base_url(); ?>admin/log"><img class="img-fluid for-light" src="<?php echo base_url(); ?>assets/images/logo-christmas.png" alt="" width="130px"><img class="img-fluid for-dark" src="<?php echo base_url(); ?>assets/images/logo-christmas.png" alt="" width="130px"></a>
    ...
    <nav class="sidebar-main">
      ...
      <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
          ...
          <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav <?php if($this->uri->segment(1) == 'administrator' && $this->uri->segment(2) == 'whitelist'){echo 'active-nav';} ?>" href="<?php echo base_url(); ?>administrator/whitelist"><i data-feather="file-text"> </i><span>Whitelist</span></a></li>
